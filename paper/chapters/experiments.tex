...
\begin{figure}[p]%
	...
	\begin{gnuplot}[terminal=epslatex, terminaloptions={color dashed size 6.5cm,6cm font "lmodern,8"}]
		...
		plot "data/output_snr_256.txt" using 4:5 w l lc 1 lw 3 t "256",\
  			 "data/output_snr_512.txt" using 4:5 w l lc 2 lw 3 t "512",\
  			 "data/output_snr_1024.txt" using 4:5 w l lc 3 lw 3 t "1024",\
  			 "data/output_snr_2048.txt" using 4:5 w l lc 4 lw 3 t "2048"
	\end{gnuplot}}\
