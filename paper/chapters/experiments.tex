...
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[scale=.9]{img/exp_input.png}
...
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[scale=.9]{img/exp_inputpatterns.png}
...
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[scale=.9]{img/exp_result.png}
...
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[scale=.9]{img/exp_diff.png}
\caption{Difference}
\label{fig-example1c}
\end{subfigure}%
