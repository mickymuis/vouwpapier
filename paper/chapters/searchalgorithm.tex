...
\begin{minipage}[t]{.49\textwidth}
	...
	\Require $\bar{H}$
	\Ensure $C$, ${usage}()$
	\ForAll{$\bar{X} \in \bar{H}$}
		\ForAll{$\bar{Y} \in \mathrm{POST}(\bar{X})$}
...
%			    = &\log \Gamma(U(X)+\epsilon) - \log \Gamma(\epsilon) + \log \Gamma(U(Y)+\epsilon) - \log \Gamma(\epsilon) - \log \Gamma(U(X)+U(Z)+\epsilon) + \log \Gamma(\epsilon) - \log \Gamma(U(Y)+U(Z)+\epsilon) + \log \Gamma(\epsilon) - \log \Gamma(U(Z)+\epsilon) + \log \Gamma(\epsilon) + \log \Gamma(|\bar{H}|+|H|\epsilon) - \log \Gamma(|H|\epsilon) - \log \Gamma(|\bar{H'}|+|H'|\epsilon) + \log \Gamma(|H'|\epsilon) \\
%			    = &\log \Gamma(U(X)+\epsilon) + \log \Gamma(U(Y)+\epsilon) - \log \Gamma(U(X)+U(Z)+\epsilon) - \log \Gamma(U(Y)+U(Z)+\epsilon) - \log \Gamma(U(Z)+\epsilon) + \log \Gamma(\epsilon) + \log \Gamma(|\bar{H}|+|H|\epsilon) - \log \Gamma(|H|\epsilon) - \log \Gamma(|\bar{H'}|+|H'|\epsilon) + \log \Gamma(|H'|\epsilon)			    
\end{split}   
\end{align}
