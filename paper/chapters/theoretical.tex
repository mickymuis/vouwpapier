...
\label{tablelength}
\vspace{3pt}
\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}}llcccc}
\toprule
...
$L_1(H)$ && Model & \emph{N/A} & $L_N(|H|)$ & \emph{N/A} & $L_p(X \in H)$ \\
$L_2({I})$ && Instantiation matrix& \emph{constant} & $\log(MN)$ & \emph{implicit} & $L_{pp}({I})$\\
\bottomrule
\end{tabular*}
\end{table}
